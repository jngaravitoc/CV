...
41 Total: 16 Invited, 26 in North America, 5 in Europe, 7 in Latin America, 1 Asia.\\
...
\begin{itemize}
  \setlength\itemsep{0.0em}
  \renewcommand\labelitemi{$\cdot$}
  \item Silvio Varela (Universdad de la Serena); Nov 2022-present.
  \item Arpit Arora (University of Pennsylvania); Nov 2021-present.
  \item Andrew Eden (Florida Institute of Technology); Nov 2022-present.
...
10+ years of experience with C, C++, Python, OpenMP, HPC systems, git.\\
\subsection*{Service:} 

\begin{itemize}
  \setlength\itemsep{0.0em}
  \renewcommand\labelitemi{$\cdot$}
\item Referee of MNRAS, Nature, and ApJ. (6 papers, 2018-present)
