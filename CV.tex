...
\begin{itemize}
  ...
  \item Arpit Arora (Graduate student at University of Pennsylvania); Fall 2021-present. I am
    currently co-adivising Arpit Arora in two research projects, one already submitted to ApJ.
...
\item Stephanie Carolina Cely Rodriguez (Undergraduate at Universidad Nacional de Colombia);
  co-advising undergraduate thesis; Summer 2022-Sumer 2023.
\end{itemize}
...
refereed: 23 -- first author: 5  -- $h-$index: 11 -- citations : 809 (as of Nov 21th/2023) 
\begin{etaremune}
  \setcounter{enumi}{24}
...
\item \textit{Generating synthetic star catalogs from simulated data1
  ...
  Nikakhtar, Nondh Panithanpaisal, Nicol\'as Garavito-Camargo,
