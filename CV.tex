...
\begin{itemize}
  ...
  \item Elise Darragh-Ford (Graduate student at Stanford); Fall 2023-present. I
    ...
    chapter of Elise's PhD thesis. Paper in prep. 
  \item Silvio Varela (Graduate student at Universdad de la Serena); Fall 2022-present. I am
    currently co-advising Silvio in one research project. Paper in prep.  
  \item Arpit Arora (Graduate student at University of Pennsylvania); Fall 2021-present. I am
    currently co-adivising Arpit Arora in two research projects, one paper is
    submitted to ApJ and one is in prep.
  ...
  resulted in a submitted publication and one other is in prep.    
  \item Andrew Eden (Undergraduate at Florida Institute of Technology); Fall 2022-present.
    I am currently advising Andrew on his undergraduate thesis project. One
    paper is in prep.  
  \item Ludia Adhikary (Undegraduate CUNY); co-supervised with Emily Cunningham.
...
\begin{itemize}
  \setlength\itemsep{0.0em}
  \renewcommand\labelitemi{$\cdot$}
  \item Core developer and active contributor of:
    \href{https://github.com/athob/py-ananke}{py-Ananke}, \href{https://gala.adrian.pw/en/latest/}{gala}, EXPtools, NBA, Cranes. 
  \item Expertise running HPC codes: Gadget-3, 4, EXP (CPU \& GPU), AREPO.  
...
\begin{itemize}
  \setlength\itemsep{0.0em}
  \renewcommand\labelitemi{$\cdot$}
\item Hubble Space Telescope, 32 orbits, Cycle 31, 2023. PI: Sukanya Chakrabarti. 
\item MareNostrum Super computer, 1.7 million CPU hours, AECT-2023-2-0016, 2023. PI: Dr. Chervin Laporte. 
\item GMRT 60 hours cycle 44, 2023. PI: Karin Menendez-Delmestre.
\item Blanco Telescope, ``\textit{ A VISTA-DECam Experiment in Near-Field
  Cosmology: Search for the Magellanic Dark Matter Wake}" cycle 2020B. PI: Julio
  Chaname, 3 nights.
\end{itemize}
